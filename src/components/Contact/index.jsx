...
const redes = [{
  red: 'Instagram',
  link: 'https://www.instagram.com/agustinpetrini/',
  icon: <IoLogoInstagram />
}, {
  red: 'Linkedin',
  link: 'https://www.linkedin.com/in/agust%C3%ADn-petrini-a6175521a/',
  icon: <AiFillLinkedin />
}, {
  red: 'Git Hub',
  link: 'https://github.com/Petri36',
  icon: <AiFillGithub />
}]
...
const methodContact = [
  {
    method: 'email',
    href: 'mailto:petriniagustin41521@gmail.com',
    title: 'petriniagustin41521@gmail.com'
  }, {
    method: 'telefono',
    href: 'tel:+543402500449',
    title: '+543402500449'
  }
]
