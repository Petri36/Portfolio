      ...
      <div className='flex-1 z-[2]'>
        <div className='sm:text-[50px] md:text-left text-center ' style={{ color: Themes.text }}>
          <h1 className='md:items-start text-[50px] title flex flex-col items-center leading-none font-bold relative'>
            <span className='flex mb-2 leading-3 title items-center'>Agustín <span className='ml-2'><ManoSaludando /></span></span>
            <span>FullStack Dev</span>
          </h1>
          <p className='text-sm font-normal description-hero mt-4' style={{ color: Themes.description }}>Cada Día busco nuevas tecnologías para investigar y porfundizar más en mis conocimientos.</p>
        </div>
