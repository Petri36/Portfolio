    ...
    <div className='min-h-[400px] mb-36  relative' id='abountme'>
      ...
      <div className='flex items-center justify-center md:flex-row flex-col'>
        <div className='flex-1'>
          <p className=' text-start font-normal sm:text-lg text-base' style={{ color: Themes.description }}>Soy un desarrollador Fullstack con experiencia en diversas tecnologías de frontend y backend. En el frontend, he trabajado con HTML y CSS para crear interfaces de usuario atractivas y responsivas, así como con React.js, Next.js, Zustand y Redux para desarrollar aplicaciones web dinámicas y escalables.
