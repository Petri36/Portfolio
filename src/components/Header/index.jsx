    ...
    <>
      <header className="h-24 z-10 fixed left-0 top-0 lg:px-28 px-7  w-full">
        <div className="flex justify-between items-center w-full h-[100%]">
          <div>
            ...
            >
              <div className="w-full h-full rounded-full">
                <img
                  src="https://res.cloudinary.com/dfkvvcfxs/image/upload/v1682079730/logo_vorruv.png"
                  alt="logo portfolio"
          ...
          <div>
            <nav
              className={`md:flex navBar text-sm py-[6px] relative font-semibold px-6 ${
                isShow ? "flex" : "hidden"
              }`}
              style={{
                border: `1px solid ${Themes.borderNav}`,
          ...
          <div className="flex items-center">
            <div className="btnOpenMenu">
              <a
                href="https://www.linkedin.com/in/agust%C3%ADn-petrini-a6175521a/"
                target="_blank"
                onClick={handleShowMenu}
